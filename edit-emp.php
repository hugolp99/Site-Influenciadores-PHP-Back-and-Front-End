        ...
        <div class="limiter">
            <div class="container-login100">
			    <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" method="POST" action="saveEdit-emp.php">
                        <span class="login100-form-title p-b-26">
                            Editar Empresa
                        </span>
                            <div class="wrap-input100 validate-input">    
                                <input class="input100" type="text" name="company" value=<?php echo $company ?>>
                            </div> 
                            
                            <div class="wrap-input100 validate-input"> 
                                <input class="input100" type="e-mail" name="email" value=<?php echo $email ?>>
                            </div>
