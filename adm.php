...
<html lang="pt-br">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="admin-emp.php">Tabela Empresas</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container-listadm">
            ...
            <thead>
                    ...
                    <th scope="col">Usuário Instagram</th>
                    <th scope="col">Número de Seguidores</th>
                    <th scope="col">...</th>
                </tr>
            </thead>
            <tbody>
                    <?php
                        ...
                        $sql = "SELECT * FROM influenciadores ORDER BY id DESC";
                        ...
                        while($user_data = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo "<td>".$user_data['whats']."</td>";
                            echo "<td>".$user_data['userinsta']."</td>";
                            echo "<td>".$user_data['followinsta']."</td>";
                            echo "<td>
                                <a class='btn btn-sm btn-secondary' href='edit.php?id=$user_data[id]'>
